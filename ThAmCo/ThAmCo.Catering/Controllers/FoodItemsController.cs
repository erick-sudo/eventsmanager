...
namespace ThAmCo.Catering.Controllers
{
    public class FoodItemsController : Controller
    {
        ...
        [Route("/[controller]/[action]")]
        public async Task<IActionResult> Create([Bind("FoodItemId,FoodItemName,Description,UnitPrice")] FoodItem foodItem)
        {
        ...
        [ValidateAntiForgeryToken]
        [Route("/[controller]/[action]/{id}")]
        public async Task<IActionResult> Edit(int id, [Bind("FoodItemId,FoodItemName,Description,UnitPrice")] FoodItem foodItem)
        {
